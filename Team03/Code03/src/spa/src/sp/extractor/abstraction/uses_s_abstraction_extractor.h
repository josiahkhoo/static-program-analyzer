#ifndef SPA_TEAM03_CODE03_SRC_SPA_SRC_SP_EXTRACTOR_ABSTRACTION_USES_S_ABSTRACTION_EXTRACTOR_H_
#define SPA_TEAM03_CODE03_SRC_SPA_SRC_SP_EXTRACTOR_ABSTRACTION_USES_S_ABSTRACTION_EXTRACTOR_H_

#include "common/abstraction/uses_s_abstraction.h"
#include "sp/extractor/sub_abstraction_extractor.h"

class UsesSAbstractionExtractor
    : public SubAbstractionExtractor<UsesSAbstraction> {
 public:
  std::vector<UsesSAbstraction> Extract(
...
#endif  // SPA_TEAM03_CODE03_SRC_SPA_SRC_SP_EXTRACTOR_ABSTRACTION_USES_S_ABSTRACTION_EXTRACTOR_H_
