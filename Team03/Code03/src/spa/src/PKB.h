...
class PKB : public QueryablePkb, public StorablePkb {
 public:
  ...
  std::unordered_set<std::string> QueryCalls(std::string identifier) const override;
  std::unordered_set<std::string> QueryCallsBy(std::string identifier) const override;
  std::unordered_set<std::string> QueryCallsT(std::string identifier) const override;
  std::unordered_set<std::string> QueryCallsTBy(std::string identifier) const override;
