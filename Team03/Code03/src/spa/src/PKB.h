...
class PKB : public QueryablePkb, public StorablePkb {
 public:
  ...
  std::unordered_set<std::string> QueryUsesPBy(std::string identifier,
                                               EntityType type) const override;
  std::unordered_set<std::string> QueryAllModifies(EntityType type) const override;
  std::unordered_set<std::string> QueryAllModifiesBy(
      EntityType type) const override;
  std::unordered_set<std::string> QueryAllModifiesRelations() const override;
  std::unordered_set<std::string> QueryModifiesS(int statement_number,
                                             EntityType type) const override;
  std::unordered_set<std::string> QueryModifiesSBy(std::string identifier,
                                               EntityType type) const override;
  std::unordered_set<std::string> QueryModifiesP(std::string identifier,
                                             EntityType type) const override;
  std::unordered_set<std::string> QueryModifiesPBy(std::string identifier,
                                               EntityType type) const override;
