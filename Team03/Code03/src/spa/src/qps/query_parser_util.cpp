...
StatementReference QueryParserUtil::ExtractStmtRef(
    TokenHandler& tokens, const QueryStringBuilder& builder) {
...
EntityType QueryParserUtil::ExtractEntityType(TokenHandler& tokens) {
  EntityType result;
...
std::string QueryParserUtil::GetExpression(TokenHandler& tokens,
...
std::string QueryParserUtil::GetTerm(TokenHandler& tokens,
                                     const QueryStringBuilder& builder) {
  std::string res;
  Token next = tokens.Peek();
