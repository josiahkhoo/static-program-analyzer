#ifndef QUERY_PARSER_CPP_NEXT_CLAUSE_H
#define QUERY_PARSER_CPP_NEXT_CLAUSE_H
...
class NextClause : public Clause {
 public:
  NextClause(StatementReference lhs, StatementReference rhs);
...
#endif  // QUERY_PARSER_CPP_NEXT_CLAUSE_H
