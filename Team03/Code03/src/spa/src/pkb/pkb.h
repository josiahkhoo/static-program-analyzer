...
class PKB {
 public:
  ...
  //      override;  // Store both assign entity and pattern to statement
  //      storage
  ...
  // Uses query methods
  //  std::unordered_set<std::string> QueryAllUses(EntityType type) const
  //  override; std::unordered_set<std::string> QueryAllUsesBy(
  //      EntityType type) const override;
  ...
  //  // Next query methods
  //  std::unordered_set<std::string> QueryAllNext(EntityType type) const
  //  override; std::unordered_set<std::string> QueryAllPrevious(
  //      EntityType type) const override;
  ...
  //  std::unordered_set<std::string> QueryAffects(int statement_number)
  //  override; std::unordered_set<std::string> QueryAffectsBy(int
  //  statement_number) override; std::unordered_set<std::string>
  //  QueryAffectsT(int statement_number) override;
