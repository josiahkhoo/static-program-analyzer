...
///// \param statement_number
///// \param type
///// \return Query all statements directly or indirectly followed by a
///specified
///// statement
...
///// Statement types)
// std::unordered_set<std::string> PKB::QueryAllModifiesBy(EntityType type)
// const {
//   std::unordered_set<std::string> result;
//   if (type == EntityType::CONSTANT || type == EntityType::VARIABLE) {
//     result = {};
...
// {
//   return FindIntersect(relationship_manager_.GetAllPrevious(),
//   QueryAll(type));
// }
//
///// QueryAllNext
...
//   std::unordered_set<std::string> result =
//   relationship_manager_.GetAllNext(); std::unordered_set<std::string>
//   previous =
...
///// \return Query statement(s) that immediately comes next after given
///statement
...
//   entity_manager_.GetCallStatements(); std::unordered_set<std::string> reads
//   = entity_manager_.GetReadStatements(); return
//   relationship_manager_.GetAllAffects(assigns, calls, reads);
// }
//
///// QueryAllAffectsBy
...
//   entity_manager_.GetCallStatements(); std::unordered_set<std::string> reads
//   = entity_manager_.GetReadStatements(); return
//   relationship_manager_.GetAllAffectsBy(assigns, calls, reads);
// }
//
///// QueryAffects
///// \param statement_number statement
...
//   std::unordered_set<std::string> calls =
//   entity_manager_.GetCallStatements(); std::unordered_set<std::string> reads
//   = entity_manager_.GetReadStatements(); if
//   (CheckNotAssignStmtNo(statement_number)) {
//     return {};
//   }
...
//     entity_manager_.GetVariables(); if (variables.find(identifier) !=
//     variables.end()) {
//       result.emplace(identifier);
//     }
...
//     entity_manager_.GetConstants(); if
//     (constants.find(std::to_string(number)) != constants.end()) {
...
//   std::unordered_set<std::string> whiles =
//   entity_manager_.GetWhileStatements(); std::unordered_set<std::string> reads
//   = entity_manager_.GetReadStatements(); std::unordered_set<std::string>
//   prints = entity_manager_.GetPrintStatements();
//   std::unordered_set<std::string> calls =
//   entity_manager_.GetCallStatements(); if
//   (assigns.find(std::to_string(stmt_no)) != assigns.end()) {
//     return true;
