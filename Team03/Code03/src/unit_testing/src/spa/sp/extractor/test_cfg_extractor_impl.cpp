...
TEST_CASE("CFG Extractor", "[CFGExtractor]") {
  ...
  SECTION("Extract statements triple nested if node") {
     ...
     REQUIRE(res_nodes2.size() == 1);
     REQUIRE(std::find(res_nodes2.begin(), res_nodes2.end(), CFGNode({9})) != res_nodes2.end());
  ...
  SECTION("Extract statements triple nested if node 2") {
     ...
     REQUIRE(res_nodes2.size() == 1);
     REQUIRE(std::find(res_nodes2.begin(), res_nodes2.end(), CFGNode({8})) != res_nodes2.end());
     ...
     REQUIRE(res_nodes4.size() == 1);
     REQUIRE(std::find(res_nodes4.begin(), res_nodes4.end(), CFGNode({8})) != res_nodes4.end());
     ...
     REQUIRE(res_nodes7.size() == 1);
     REQUIRE(std::find(res_nodes7.begin(), res_nodes7.end(), CFGNode({8})) != res_nodes7.end());
  ...
  SECTION("Extract statements before while node") {
    ...
    REQUIRE(res_nodes3.size() == 1);
    REQUIRE(std::find(res_nodes3.begin(), res_nodes3.end(), CFGNode({2})) != res_nodes3.end());
  }
  ...
  SECTION("Extract statements after while node") {
    ...
    REQUIRE(res_nodes2.size() == 1);
    REQUIRE(std::find(res_nodes2.begin(), res_nodes2.end(), CFGNode({1})) != res_nodes2.end());
  ...
  SECTION("Extract statements before and after while node") {
    ...
    REQUIRE(res_nodes3.size() == 1);
    REQUIRE(std::find(res_nodes3.begin(), res_nodes3.end(), CFGNode({3})) != res_nodes3.end());
  ...
  SECTION("Extract statements while-s-if nested node") {
    ...
    REQUIRE(res_nodes1.size() == 2);
    REQUIRE(std::find(res_nodes1.begin(), res_nodes1.end(), CFGNode({2})) != res_nodes1.end());
    REQUIRE(std::find(res_nodes1.begin(), res_nodes1.end(), CFGNode({6})) != res_nodes1.end());
    ...
    REQUIRE(res_nodes5.size() == 1);
    REQUIRE(std::find(res_nodes5.begin(), res_nodes5.end(), CFGNode({1})) != res_nodes5.end());
  ...
  SECTION("Extract statements while-if-if s nested node") {
    ...
    REQUIRE(res_nodes1.size() == 2);
    REQUIRE(std::find(res_nodes1.begin(), res_nodes1.end(), CFGNode({2})) != res_nodes1.end());
    REQUIRE(std::find(res_nodes1.begin(), res_nodes1.end(), CFGNode({8})) != res_nodes1.end());
    ...
    REQUIRE(res_nodes3.size() == 1);
    REQUIRE(std::find(res_nodes3.begin(), res_nodes3.end(), CFGNode({7})) != res_nodes3.end());
    ...
    REQUIRE(res_nodes7.size() == 1);
    REQUIRE(std::find(res_nodes7.begin(), res_nodes7.end(), CFGNode({1})) != res_nodes7.end());
  ...
  SECTION("Extract statements while-if-if if nested node") {
    ...
    REQUIRE(res_nodes1.size() == 2);
    REQUIRE(std::find(res_nodes1.begin(), res_nodes1.end(), CFGNode({2})) != res_nodes1.end());
    REQUIRE(std::find(res_nodes1.begin(), res_nodes1.end(), CFGNode({12})) != res_nodes1.end());
    ...
    REQUIRE(res_nodes3.size() == 1);
    REQUIRE(std::find(res_nodes3.begin(), res_nodes3.end(), CFGNode({11})) != res_nodes3.end());
    ...
    REQUIRE(res_nodes8.size() == 1);
    REQUIRE(std::find(res_nodes8.begin(), res_nodes8.end(), CFGNode({10})) != res_nodes8.end());
    ...
    REQUIRE(std::find(res_nodes9.begin(), res_nodes9.end(), CFGNode({10})) != res_nodes9.end());
    ...
    REQUIRE(std::find(res_nodes10.begin(), res_nodes10.end(), CFGNode({11})) != res_nodes10.end());
    ...
    REQUIRE(std::find(res_nodes11.begin(), res_nodes11.end(), CFGNode({1})) != res_nodes11.end());
  ...
  SECTION("Extract statements while-if-while if nested node") {
    ...
    REQUIRE(res_nodes1.size() == 2);
    REQUIRE(std::find(res_nodes1.begin(), res_nodes1.end(), CFGNode({2})) != res_nodes1.end());
    REQUIRE(std::find(res_nodes1.begin(), res_nodes1.end(), CFGNode({11})) != res_nodes1.end());
    ...
    REQUIRE(res_nodes3.size() == 1);
    REQUIRE(std::find(res_nodes3.begin(), res_nodes3.end(), CFGNode({10})) != res_nodes3.end());
    ...
    REQUIRE(res_nodes5.size() == 1);
    REQUIRE(std::find(res_nodes5.begin(), res_nodes5.end(), CFGNode({4})) != res_nodes5.end());
    ...
    REQUIRE(res_nodes10.size() == 1);
    REQUIRE(std::find(res_nodes10.begin(), res_nodes10.end(), CFGNode({1})) != res_nodes10.end());
  ...
  SECTION("Extract statements if-if-while nested node") {
    ...
    REQUIRE(res_nodes4.size() == 1);
    REQUIRE(std::find(res_nodes4.begin(), res_nodes4.end(), CFGNode({7})) != res_nodes4.end());
    ...
    REQUIRE(res_nodes6.size() == 1);
    REQUIRE(std::find(res_nodes6.begin(), res_nodes6.end(), CFGNode({5})) != res_nodes6.end());
  ...
  SECTION("Extract statements if-while-if nested node") {
    ...
    REQUIRE(res_nodes5.size() == 1);
    REQUIRE(std::find(res_nodes5.begin(), res_nodes5.end(), CFGNode({3})) != res_nodes5.end());
    ...
    REQUIRE(res_nodes6.size() == 1);
    REQUIRE(std::find(res_nodes6.begin(), res_nodes6.end(), CFGNode({3})) != res_nodes6.end());
  ...
  SECTION("Extract statements if-while-while nested node") {
    ...
    REQUIRE(res_nodes3.size() == 2);
    REQUIRE(std::find(res_nodes3.begin(), res_nodes3.end(), CFGNode({4})) != res_nodes3.end());
    REQUIRE(std::find(res_nodes3.begin(), res_nodes3.end(), CFGNode({6})) != res_nodes3.end());
  ...
  SECTION("Extract statements while-while-if nested node") {
    ...
    REQUIRE(res_nodes4.size() == 1);
    REQUIRE(std::find(res_nodes4.begin(), res_nodes4.end(), CFGNode({2})) != res_nodes4.end());
