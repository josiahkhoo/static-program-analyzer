...
//  }
  ...
  SECTION("Test more while condition (Relexpr) == (RelExpr)") {
    ...
    std::shared_ptr<TNode> variable_b_node_ptr =
        std::make_shared<TNode>(variable_b_node);
    std::shared_ptr<TNode> const_node_ptr2 = std::make_shared<TNode>(const_node2);
    ...
    // WHILE CONDITION NODE
    TNode eq_node2 = TNode(6, TNode::Equal, 1,
                              {variable_z_node_ptr, const_node_ptr3});
    ...
    TNode while_node2 =
        TNode(7, TNode::While, 1, {while_cond_node_ptr_2, while_stmt_list_ptr_2});
    ...
    std::shared_ptr<TNode> shared_stmt_list_node_ptr2 =
        std::make_shared<TNode>(while_node2);
    TNode stmt_list_node =
        TNode(16, TNode::StatementList, {shared_stmt_list_node_ptr2, shared_stmt_list_node_ptr, assign_node_ptr2});
