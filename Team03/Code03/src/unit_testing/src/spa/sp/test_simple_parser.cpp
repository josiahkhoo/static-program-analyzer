...
TEST_CASE("Simple Parser", "[Simple Parser]") {
  ...
  //    TNode program_node = TNode(5, TNode::Program,
  //    {shared_program_node_ptr_});
  //
  //    TNode invalid_node =
  ...
  //        Token(Token::IDENTIFIER, "procedure"), Token(Token::IDENTIFIER,
  //        "main"), Token(Token::LEFT_CURLY_BRACKET), Token(Token::IDENTIFIER,
  //        "read"), Token(Token::IDENTIFIER, "x"), Token(Token::SEMICOLON),
  ...
  //    TNode print_node2 = TNode(2, TNode::Print, 4,
  //    {shared_print_node_ptr_2});
  //
  ...
  //    TNode plus_node =
  //        TNode(3, TNode::Plus, 1, {lhs_plus_var_node_ptr_,
  //        rhs_const_node_ptr_});
  //
  ...
  //    std::make_shared<TNode>(plus_node); TNode assign_node =
  ...
  //    std::shared_ptr<TNode> shared_program_node_ptr_ =
  //        std::make_shared<TNode>(procedure_node);
  //    TNode program_node = TNode(8, TNode::Program,
  //    {shared_program_node_ptr_});
  //
  //    TNode invalid_node =
  //        TNode(9, TNode::Invalid, std::vector<std::shared_ptr<TNode>>());
  ...
  //                              {cond_variable_node_ptr_,
  //                              cond_const_node_ptr_});
  //
  //    // WHILE NODE
  ...
  //
  //    TNode while_node =
  //        TNode(7, TNode::While, 1, {while_cond_node_ptr_,
  //        while_stmt_list_ptr_});
  //
  //    std::shared_ptr<TNode> shared_stmt_list_node_ptr_ =
  ...
  //
  //    std::shared_ptr<TNode> read_node_ptr_ =
  //    std::make_shared<TNode>(read_node); TNode else_stmt_list_node =
  ...
  //              {if_cond_node_ptr_, then_stmt_list_ptr_,
  //              else_stmt_list_ptr_});
  //
  //    std::shared_ptr<TNode> shared_stmt_list_node_ptr_ =
  ...
  //    std::shared_ptr<TNode> shared_program_node_ptr_ =
  //        std::make_shared<TNode>(procedure_node);
  //    TNode program_node = TNode(13, TNode::Program,
  //    {shared_program_node_ptr_});
  //
  //    TNode invalid_node =
  ...
  //    std::shared_ptr<TNode> shared_print_node_ptr_2 =
  //        std::make_shared<TNode>(variable_y_node);
  //    TNode print_node_2 = TNode(6, TNode::Read, 2,
  //    {shared_print_node_ptr_2});
  //
  //    std::shared_ptr<TNode> shared_stmt_list_node_ptr_2 =
  ...
  //    std::make_shared<TNode>(print_node); TNode while_stmt_list_node =
  ...
  //    std::make_shared<TNode>(and_node); TNode while_node =
  ...
  //
  //    TNode assign_node = TNode(9, TNode::Assign, 1, {z_node_ptr,
  //    plus_node_ptr});
  //
  //    std::shared_ptr<TNode> shared_stmt_list_node_ptr =
  //        std::make_shared<TNode>(assign_node);
  ...
  //
  //    // Stmtlist Node
  //    std::shared_ptr<TNode> read_node_ptr =
  //    std::make_shared<TNode>(read_node); TNode while_stmt_list_node =
  ...
  //    std::shared_ptr<TNode> while_stmt_list_ptr =
  //        std::make_shared<TNode>(while_stmt_list_node);
  //    std::shared_ptr<TNode> while_cond_ptr =
  //    std::make_shared<TNode>(eq_node); TNode while_node =
  ...
  //
  //    // Stmtlist Node
  //    std::shared_ptr<TNode> read_node_ptr2 =
  //    std::make_shared<TNode>(read_node2); TNode while_stmt_list_node2 =
  ...
  //    std::shared_ptr<TNode> while_cond_ptr2 =
  //    std::make_shared<TNode>(eq_node2); TNode while_node2 =
  //        TNode(14, TNode::While, 4, {while_cond_ptr2, while_stmt_list_ptr2});
  //
  //    // IF ELSE NODE CONSTRUCTION
  //    // THEN STATEMENTLIST
  //    std::shared_ptr<TNode> while_node_ptr =
  //    std::make_shared<TNode>(while_node); TNode then_stmt_list_node =
  ...
  //    // Then Stmtlist Node
  //    std::shared_ptr<TNode> read_node_ptr =
  //    std::make_shared<TNode>(read_node); TNode then_stmt_list_node = TNode(3,
  //    TNode::StatementList, {read_node_ptr});
  //
  //    // Read y node
  ...
  //    // Else Stmtlist Node
  //    std::shared_ptr<TNode> read_node_ptr2 =
  //    std::make_shared<TNode>(read_node2); TNode else_stmt_list_node =
  ...
  //    TNode while_stmt_list_node = TNode(14, TNode::StatementList,
  //    {if_node_ptr});
  //
  //    // WHILE NODE
  //    std::shared_ptr<TNode> while_stmt_list_ptr =
  ...
  //    std::shared_ptr<TNode> const_node_ptr =
  //    std::make_shared<TNode>(const_node);
  //
  //    // Assignment Node
  ...
  //    // While Cond Node
  //    TNode plus_node =
  //        TNode(6, TNode::Plus, 1, {variable_x_node_ptr,
  //        variable_x_node_ptr2});
  //    TNode plus_node2 =
  //        TNode(6, TNode::Plus, 1, {variable_y_node_ptr,
  //        variable_y_node_ptr2});
  //
  //    std::shared_ptr<TNode> plus_node_ptr =
  //    std::make_shared<TNode>(plus_node); std::shared_ptr<TNode>
  //    plus_node_ptr2 = std::make_shared<TNode>(plus_node2);
  //
  //    TNode eq_node = TNode(6, TNode::Equal, 1, {plus_node_ptr,
  //    plus_node_ptr2});
  //
  ...
  //    // While node
  //    TNode while_node =
  //        TNode(6, TNode::While, 1, {while_cond_node_ptr,
  //        while_stmt_list_ptr});
  //
  //    // Program Node
  //    std::shared_ptr<TNode> shared_stmt_list_node_ptr =
  ...
  //        std::make_shared<TNode>(variable_a_node);
  //    std::shared_ptr<TNode> const_node_ptr =
  //    std::make_shared<TNode>(const_node); std::shared_ptr<TNode>
  //    variable_b_node_ptr =
  ...
  //    plus_node_ptr2});
  //
  //    std::shared_ptr<TNode> if_cond_node_ptr =
  //    std::make_shared<TNode>(eq_node);
  //
  //    // If node
  //    TNode while_node =
